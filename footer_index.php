            ...
            <div class="col-md-3">
                <div class="footer-col" style="background-color: #367DAB;height:289px; padding: 10px;">
                    ...
                    <ul class="list-unstyled latest-f-news">
                        ...
                        <li><a href="<?php echo baseUrl(); ?>all_client.php" style="color: white;"><i class="fa fa-crosshairs" aria-hidden="true"></i>&nbsp;&nbsp;Clients</a></li>
                        <li><a href="<?php echo baseUrl(); ?>equipment.php" style="color: white;"><i class="fa fa-crosshairs" aria-hidden="true"></i>&nbsp;&nbsp;Equipments</a></li>
                        <li><a href="javascript:void(0);" style="color: white;"><i class="fa fa-crosshairs" aria-hidden="true"></i>&nbsp;&nbsp;Gallery</a></li>
                        <li><a href="javascript:void(0);" style="color: white;"><i class="fa fa-crosshairs" aria-hidden="true"></i>&nbsp;&nbsp;Career</a></li>
                        <li><a href="<?php echo baseUrl(); ?>contact.php" style="color: white;"><i class="fa fa-crosshairs" aria-hidden="true"></i>&nbsp;&nbsp;Contact Us</a></li>
                    </ul>
                </div>                        
            </div>
            <div class="col-md-3">
                <div class="footer-col" style="background-color: #367DAB;height:289px;  padding: 10px;">
                    ...
                    <p id="successDiv" style="display: none; color:white;">Thank you for your subscription <i class="fa fa-smile-o"></i>&nbsp;</p>
