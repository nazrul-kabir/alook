...
<html>
    <head>
        ...
        <title>Alook Refrigeration CO. Ltd | Contact Information List</title>
                                    ...
                                    function deleteFunction(contact_id) {
                                        ...
                                        if (c === true) {
                                            $.ajax({
                                                type: "POST",
                                                dataType: "json",
                                                url: baseUrl + "admin/controller/contact/list.php",
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        $("#grid").kendoGrid({
                                            ...
                                            columns: [
                                                ...
                                                {field: "contact_subject", title: "Subject", width: "150px"},
                                                {field: "contact_message", title: "Message", width: "150px"},
