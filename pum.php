...
$arrayUnder = array();
$sqlUnder = "SELECT * FROM project WHERE project_status='Active' AND project_type='Maintainance'";
$resultUnder = mysqli_query($con, $sqlUnder);
if ($resultUnder) {
    while ($objUnder = mysqli_fetch_object($resultUnder)) {
        $arrayUnder[] = $objUnder;
    }
}
?>
...
<html>
    <head>
        ...
        <title>Alook Refrigeration CO. Ltd | Projects | Projects Under Maintainance-Contract</title>
    ...
    <body id="boxed">
        <div class="boxed-wrapper">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 hidden-xs">
                            <h4>PROJECT UNDER MAINTAINANCE-CONTRACT</h4>
                        </div>
            ...
            <div class="container-fluid" style="padding-right: 0px; padding-left: 0px;">
                <h2 style="text-align: center;color: white;font-weight: 600;text-transform: uppercase;letter-spacing: 1px;font-size: 25px;border: 1px solid #367DAB; background-color: #367DAB;">PROJECT UNDER MAINTAINANCE-CONTRACT</h2>
            </div>
            <div class="container">
